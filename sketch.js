...
function setup() {
  ...
  ground.x = ground.width /2;
   ...
   gameOver = createSprite(300,height-200);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(300,height-140);
...
function draw() {
  ...
  background("white  ");
  //displaying score
  text("Score: "+ score, width-680,400);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(400,height-90,10,40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
     cloud = createSprite(600,height-70,40,10);
